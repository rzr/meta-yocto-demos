...
# the iotivity code uses these, so add:
...
SRC_URI = "http://downloads.iotivity.org/0.9.2/iotivity-0.9.2.tar.gz;name=iotivity"
...
# tinycbor needs to be fetched separately
SRC_URI += "git://github.com/01org/tinycbor.git;name=tinycbor;destsuffix=iotivity-0.9.2/extlibs/tinycbor/tinycbor;rev=master"
# and then patch for the bitbaked cross environment
SRC_URI += "file://tizencross.patch;patch=1"

inherit scons 

python () {
    IOTIVITY_TARGET_ARCH = d.getVar("TARGET_ARCH", True)
    EXTRA_OESCONS = "TARGET_OS=tizen TARGET_ARCH=" + IOTIVITY_TARGET_ARCH + " RELEASE=1 VERBOSE=1 TARGET_TRANSPORT=IP"
...
do_install() {
    ...
    #Resource Components
    #C++ APIs
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/liboc.so ${D}${libdir}

    #Logger
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/liboc_logger.so ${D}${libdir}
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/liboc_logger_core.so ${D}${libdir}

    #CSDK Shared
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/liboctbstack.so ${D}${libdir}
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libconnectivity_abstraction.so ${D}${libdir}

    #CSDK Static
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libcoap.a ${D}${libdir} 
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/liboctbstack.a ${D}${libdir} 

    #Resource C++ Apps
    install -d ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/presenceclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/presenceserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/roomclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/roomserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/simpleclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/simpleclientserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/simpleserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/fridgeclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/fridgeserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp   
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/garageclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp   
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/garageserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/simpleclientHQ ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/simpleserverHQ ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/devicediscoveryserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/devicediscoveryclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/groupserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/groupclient ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/threadingsample ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp  
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/examples/lightserver ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/examples/OICMiddle/OICMiddle ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp
    chrpath -d ${IOTIVITY_BIN_DIR_D}/examples/resource/cpp/*   

    # not in tizen build?
    #Resource CSDK Apps
    install -d ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/occlientcoll ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/ocserver ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/ocserverbasicops ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/occlientslow ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/ocserverslow ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/occlientbasicops ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/ocservercoll ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/SimpleClientServer/occlient ${IOTIVITY_BIN_DIR_D}/examples/resource/c/SimpleClientServer
    ...
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/secure/ocserverbasicops ${IOTIVITY_BIN_DIR_D}/examples/resource/c/secure
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/secure/gen_sec_bin ${IOTIVITY_BIN_DIR_D}/examples/resource/c/secure
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/secure/occlientbasicops ${IOTIVITY_BIN_DIR_D}/examples/resource/c/secure
    #chrpath -d ${IOTIVITY_BIN_DIR_D}/examples/resource/c/secure/*
  
    # not in tizen build?
    #Resource Tests
    install -d ${IOTIVITY_BIN_DIR_D}/tests/resource    
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/ocrandom/test/randomtests ${IOTIVITY_BIN_DIR_D}/tests/resource/ocrandom_tests
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/unittests/unittests ${IOTIVITY_BIN_DIR_D}/tests/resource/oc_unittests
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/test/stacktests ${IOTIVITY_BIN_DIR_D}/tests/resource/octbstack_tests
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/connectivity/test/catests ${IOTIVITY_BIN_DIR_D}/tests/resource/ca_tests
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/oc_logger/examples/examples_cpp ${IOTIVITY_BIN_DIR_D}/tests/resource/logger_test_cpp
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/resource/oc_logger/examples/examples_c ${IOTIVITY_BIN_DIR_D}/tests/resource/logger_test_c
    ...
    #Service Components
    #PPM
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libppm.a ${D}${libdir} 

    #PPM Implementation (with Cpluff)
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libpmimpl.so ${D}${libdir}

    #MQTT Protocol
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libmosquitto.a ${D}${libdir} 
    ...
    #MQTT Fan Plugin
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/protocol-plugin/plugins/mqtt-fan/fanserver_mqtt_plugin.so ${IOTIVITY_BIN_DIR_D}/service/protocol-plugins/mqtt-fan
    ...
    #MQTT Light Plugin
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/protocol-plugin/plugins/mqtt-light/lightserver_mqtt_plugin.so ${IOTIVITY_BIN_DIR_D}/service/protocol-plugins/mqtt-light
    ...
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/protocol-plugin/sample-app/linux/mqtt/mqttclient ${IOTIVITY_BIN_DIR_D}/examples/service/protocol-plugin-apps/sample-app
    ...
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libTGMSDKLibrary.so ${D}${libdir} 
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libTGMSDKLibrary.a ${D}${libdir} 

    # not in tizen build?
    #Things Manager Apps
    #install -d ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/configuration
    #cd ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/things-manager/sampleapp/linux/configuration && find . -executable -exec install -c -m 555 "{}" ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/configuration/"{}" \;
    #install -d ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/groupaction
    #cd ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/things-manager/sampleapp/linux/groupaction && find . -executable -exec install -c -m 555 "{}" ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/groupaction/"{}" \;
    #install -d ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/groupsyncaction
    #cd ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/things-manager/sampleapp/linux/groupsyncaction && find . -executable -exec install -c -m 555 "{}" ${IOTIVITY_BIN_DIR_D}/examples/service/things-manager/groupsyncaction/"{}" \;

    # not in tizen build?
    #Notification Manager Framework
    #install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/notification-manager/libNotificationManager.a ${D}${libdir} 

    # not in tizen build?
    #Notification Manager Apps
    #install -d ${IOTIVITY_BIN_DIR_D}/examples/service/notification-manager/
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/notification-manager/SampleApp/linux/notificationmanager ${IOTIVITY_BIN_DIR_D}/examples/service/notification-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/notification-manager/SampleApp/linux/sampleconsumer ${IOTIVITY_BIN_DIR_D}/examples/service/notification-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/notification-manager/SampleApp/linux/sampleprovider ${IOTIVITY_BIN_DIR_D}/examples/service/notification-manager

    #Soft Sensor Manager Core
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libSSMCore.so ${D}${libdir} 
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/libSSMSDK.a ${D}${libdir} 

    #Soft Sensor Plugins
    install -d ${IOTIVITY_BIN_DIR_D}/service/soft-sensor-plugins
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libBMISensor.so ${IOTIVITY_BIN_DIR_D}/service/soft-sensor-plugins
    install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/libDiscomfortIndexSensor.so ${IOTIVITY_BIN_DIR_D}/service/soft-sensor-plugins
    # not in tizen build?
    #install -c -m 444 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/SoftSensorDescription.xml ${IOTIVITY_BIN_DIR_D}/service/soft-sensor-plugins

    # not in tizen build?
    #Soft Sensor Manager Apps
    install -d ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager/
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/HeightSensorApp ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/SSMTesterApp ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/THSensorApp ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/THSensorApp1 ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager
    #install -c -m 555 ${S}/out/tizen/${IOTIVITY_TARGET_ARCH}/release/service/soft-sensor-manager/WeightSensorApp ${IOTIVITY_BIN_DIR_D}/examples/service/soft-sensor-manager
...
FILES_iotivity-service-staticdev = "\
			${libdir}/libppm.a \
                        ...
                        ${libdir}/libSSMSDK.a" 
# Omitted: ${libdir}/libNotificationManager.a
