...
DESCRIPTION = "Minimalist Iotivity Client/Server application that controls a single GPIO output"
...
SRCREV = "master"
SRC_URI = "git://github.com/TizenTeam/iotivity-example.git/;protocol=http;nobranch=1;name=iotivity-example-mraa"
