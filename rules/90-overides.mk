...
rule/overide/patch/tizen-distro: sources/tizen-distro/
	-grep -r '^[\ ]*ldconfig[\ ]*$$' $< | cut -d: -f1 | sort | uniq | while read t ; do sed -e 's/^[ ]*ldconfig[ ]*$$/\[ \"\" != "\$$D\" \] || ldconfig # TODO/g' -i $$t  && echo "ldconfig: $$t" ; done  | grep ldconfig
#	-cd $< && git diff
...
rule/overide/patch: rule/sources rule/overide/patch/tizen-distro rule/overide/patch/meta-oic rule/overide/patch/meta-raspberrypi/master

rule/overide/sources: rule/sources rule/overide/patch
