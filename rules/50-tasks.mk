...
rule/all: rule/done/configure rule/overide/rule/env/image

rule/repo/%: ${repo_dir}/.repo ${repo}
	cd ${<D} && time ${repo} ${@F} && ${repo} list

rule/repo/setup: ${repo_file} rule/overide/rule/repo/init rule/overide/rule/repo/sync
	date
...
rule/setup: rule/overide/rule/build
	date
